file1 = open('ORF1Rep1SJ.out.tab', 'r')
file2 = open('ORF1Rep2SJ.out.tab', 'r')
...
c_file = open('ORF_Rep1Rep2_common.txt', 'w')
c_file.write('scaffold_number\tintron_start\tintron_end\torf_rep1_reads(u)\torf_rep1_reads(m)\torf_rep2_reads(u)'
             '\torf_rep2_reads(m)\n')
for c in commons:
...
nc_file = open('0RF_Rep1Rep2_not_common.txt', 'w')
